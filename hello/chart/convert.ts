...
import type { errorFn, evaluateFn } from '../index.js'
import {
...
/**
 * Converts historical data request to the messages relevant for Muninn using JSONata
 *
...
export const historicalConvert =
	...
	async (message: unknown): Promise<HistoricalDataResponseType[]> => {
		...
		for (const { transform } of matchedTransformers) {
